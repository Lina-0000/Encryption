...
namespace LR1
{
    partial class F2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "F2";
            this.Text = "Encryption tables with a single key permutation";
